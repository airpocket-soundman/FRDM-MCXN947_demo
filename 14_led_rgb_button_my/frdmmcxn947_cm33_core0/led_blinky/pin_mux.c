...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinConfig(PORT0, 27U, &led_gpio_out_config); /* GREEN */
    PORT_SetPinConfig(PORT1, 2U, &led_gpio_out_config);  /* BLUE  */

    /* SW2 (PORT0_23) / SW3 (PORT0_6) : GPIO input, internal pull-up (active LOW). */
    const port_pin_config_t sw_input_config = {.pullSelect          = kPORT_PullUp,
                                               .pullValueSelect     = kPORT_LowPullResistor,
                                               .slewRate            = kPORT_FastSlewRate,
                                               .passiveFilterEnable = kPORT_PassiveFilterDisable,
                                               .openDrainEnable     = kPORT_OpenDrainDisable,
                                               ...
                                               .invertInput         = kPORT_InputNormal,
                                               .lockRegister        = kPORT_UnlockRegister};
    PORT_SetPinConfig(PORT0, 23U, &sw_input_config); /* SW2 */
    PORT_SetPinConfig(PORT0, 6U, &sw_input_config);  /* SW3 */
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
