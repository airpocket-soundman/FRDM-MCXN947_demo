...
void BOARD_InitPins(void)
{
    ...
    /* GREEN LED (PORT0_27) : GPIO output. touch demo の pin_mux は元々これを設定
     * していないので、SW PWM で 3 LED 同 duty 駆動するために明示追加。 */
    const port_pin_config_t port0_27_led_green_config = {kPORT_PullDisable,
                                                          kPORT_LowPullResistor,
                                                          kPORT_FastSlewRate,
                                                          kPORT_PassiveFilterDisable,
                                                          kPORT_OpenDrainDisable,
                                                          ...
                                                          kPORT_InputNormal,
                                                          kPORT_UnlockRegister};
    PORT_SetPinConfig(PORT0, 27U, &port0_27_led_green_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
